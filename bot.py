...
async def welcome_handler(message: types.Message):
    ...
    await message.answer('We are currently monitoring every margin-trading eligible coin listed on OKX. The infomation will be updated once a minute. Type or click on subscribe to start receiving our messages.',
